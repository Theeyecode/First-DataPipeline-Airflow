...
from typing import Any, ClassVar,Callable, Collection, Mapping
...
class _SQLDecoratedOperator(DecoratedOperator, SQLExecuteQueryOperator):
    ...
    custom_operator_name: str = "Qtask.sql"
    ...
    def execute(self, context: Context) -> Any:
        ...
        if not isinstance(self.sql, str) or self.sql.strip() == "":
            raise TypeError(f"The sql returned by the callable in {self.custom_operator_name} must be a non-empty string.")
